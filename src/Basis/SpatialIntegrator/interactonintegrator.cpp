#include "interactonintegrator.h"

//------------------------------------------------------------------------------
InteractonIntegrator::InteractonIntegrator(Config *cfg): SpatialIntegrator(cfg)
{
}
//------------------------------------------------------------------------------
double InteractonIntegrator::integrate(const vec &p, const vec &q, const vec &r, const vec &s)
{
    return sqrtW*coulomb(p[2], p[3], q[2], q[3], s[2], s[3], r[2], r[3]);
}
//------------------------------------------------------------------------------
...
double InteractonIntegrator::LogRatio1(const int j1,const int j2,const int j3,const int j4)
{
...
double InteractonIntegrator::LogRatio2(const int G)
{
...
double InteractonIntegrator::LogProduct2(const int n1,const int m1,const int n2,const int m2,const int n3,const int m3,const int n4,const int m4,const int j1,const int j2,const int j3,const int j4)
{
...
double InteractonIntegrator::LogProduct3(const int l1,const int l2,const int l3,const int l4,const int gamma1,const int gamma2,const int gamma3,const int gamma4)
{
...
//------------------------------------------------------------------------------
// computes (-1)^k
int InteractonIntegrator::minusPower(const int k)
{
...
//------------------------------------------------------------------------------
// computes log(n!)
double InteractonIntegrator::LogFac (const int n)
{
    if(n>170)
    {
...
double InteractonIntegrator::Product1 (const int n1, const int ml1, const int n2, const int ml2, const int n3, const int ml3, const int n4, const int ml4)
{
    double temp=0;
...
double InteractonIntegrator::lgamma(double x)
{
#if CHECK
    if(x>=171)
    {
