#ifndef INTERACTONINTEGRATOR_H
#define INTERACTONINTEGRATOR_H

#include "SpatialIntegrator.h"

class InteractonIntegrator: public SpatialIntegrator
{
public:
    InteractonIntegrator();
    InteractonIntegrator(Config *cfg);
