...
//    I = exp(-(dot(r1,r1) + dot(r2,r2)));

//    I *=      hermitePolynomial(p[2], r1[0])
//            * hermitePolynomial(p[3], r1[1])

//            * hermitePolynomial(q[2], r2[0])
//            * hermitePolynomial(q[3], r2[1])

//            * hermitePolynomial(r[2], r1[0])
//            * hermitePolynomial(r[3], r1[1])

//            * hermitePolynomial(s[2], r2[0])
//            * hermitePolynomial(s[3], r2[1])

//            / sqrt(dot(r1 - r2,r1 - r2)/w + aa);
